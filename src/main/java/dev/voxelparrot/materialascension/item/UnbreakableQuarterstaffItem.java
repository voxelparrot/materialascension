...
public class UnbreakableQuarterstaffItem extends BasicWeaponItem {
  public UnbreakableQuarterstaffItem(Tier tier, int damage, float attackSpeed, Properties properties) {
