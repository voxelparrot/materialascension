...
public class UnbreakableFlamingGlaiveItem extends BasicWeaponItem {
  public UnbreakableFlamingGlaiveItem(Tier tier, int damage, float attackSpeed, Properties properties) {
  ...
  public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltip, TooltipFlag flag) {
    ...
    tooltip.add(Component.translatable("item.materialascension.burning").withStyle(ChatFormatting.RED, ChatFormatting.ITALIC));
  }
