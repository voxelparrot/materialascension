...
public class ArtifactHammerItem extends BasicWeaponSweeplessItem {
  public ArtifactHammerItem(Tier tier, int damage, float attackSpeed, Properties properties) {
