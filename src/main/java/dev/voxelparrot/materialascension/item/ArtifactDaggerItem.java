...
public class ArtifactDaggerItem extends BasicWeaponSweeplessItem {
  public ArtifactDaggerItem(Tier tier, int damage, float attackSpeed, Properties properties) {
