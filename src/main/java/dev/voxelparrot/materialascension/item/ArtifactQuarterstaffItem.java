...
public class ArtifactQuarterstaffItem extends BasicWeaponItem {
  public ArtifactQuarterstaffItem(Tier tier, int damage, float attackSpeed, Properties properties) {
